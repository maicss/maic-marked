    ...
    while (this.next()) {
      switch(this.token.type) {
        ...
        case 'date':
          ...
          break
        case 'tags':
          this.res.tags = this.token.text.trim().split(' ')
          break
      }
      out += this.tok()
    }
...
class Marked {
  ...
  exec (src, callback) {
    ...
    try {
      ...
      if (!this.res.tags.length || !this.res.date) throw Error('blog has no tags or date')
      return this.res
    } catch (e) {
